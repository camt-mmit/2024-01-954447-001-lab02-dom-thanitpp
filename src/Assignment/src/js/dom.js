import { createComponent, assignInputs, updateInputNumbers } from './input-component.js';
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function createSection() {
    ...
    const computeResult = () => {
      ...
      const sum = Array.from(inputs).reduce((total, input) => total + (parseFloat(input.value) || 0), 0);
    ...
    section.querySelector(".app-cmd-remove-section").addEventListener("click", (event) => {
